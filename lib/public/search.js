$(function(){
  ...
  var queryWord = $('#queryWord').text();
  
  initTimeLine('#main_contents', undefined, queryWord);
  
  $('#send_btn').click(function(event){
    event.preventDefault();
    var cmnt = $('#comment_txt').val();
    
    sendData(cmnt, chartEditor, $('#post_panel'), '#proc_status', '#proc_result',                       undefined, undefined, undefined, queryWord);
  });
  ...
  $('#quote_send_btn').click(function(event){
    ...
    sendData(cmnt, $('#quotePlot'), $('#quote_panel'), '#qtProcStatus', '#qtProcResult',
             quoteId, undefined, undefined, queryWord);
  });
  ...
  $('#reply_send_btn').click(function(event){
    ...
    sendData(cmnt, $('#replyPlot'), $('#reply_panel'), '#rpProcStatus', '#rpProcResult',
             undefined, replyId, undefined, queryWord);
  });
